...
import useIcon from '../../assets/hand.png';
import giveIcon from '../../assets/handshake.png';
        ...
        <div className="inventory-control-wrapper">
          ...
          <div className="right-controls">
            ...
            <button className="inventory-control-button inventory-control-button-give" ref={give}>
              <img src={giveIcon} alt="Give" />
            </button>
            {/**/}
            <button 
              className="inventory-control-button inventory-control-button-icon inventory-control-button-exit" 
